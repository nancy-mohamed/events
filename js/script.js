(function($) {
    ...
    /* ----- Gallery Sub menu have sub menu ----- */
    $(document).on('ready', function() {
        const $menuIcon = $('.submenu-icon');
    ...
    $menuIcon.hover(
        ...
        function() {
            setTimeout(function() {
                if (!$menuIcon.is(':hover') && !$submenu.is(':hover')) {
                    hideSubmenu();
                }
            }, 200);
        }
    ...
    // Show sub-submenu on parent item hover
    $('.has-sub-submenu').hover(
        function() {
            $(this).children('.sub-submenu').stop(true, true).fadeIn('slow');
        },
        function() {
            $(this).children('.sub-submenu').stop(true, true).fadeOut('slow');
        }
    );
    });
