...
!(function (t, e) {
  ...
  class pt extends z {
    ...
    show() {
      ...
      if (e.length) {
        ...
        if (((t = s ? pt.getInstance(s) : null), t && t._isTransitioning))
          return;
      }
    ...
    _getConfig(t) {
      return (
        ((t = { ...lt, ...V.getDataAttributes(this._element), ...t }).toggle =
          Boolean(t.toggle)),
        (t.parent = l(t.parent)),
        c(at, t, ct),
        t
  ...
  class He extends z {
    ...
    _leave(t, e) {
      (e = this._initializeOnDelegatedTarget(t, e)),
        t &&
          (e._activeTrigger["focusout" === t.type ? je : Me] =
